        ...
        <header className="flex items-center justify-between mb-6">
          ...
          <div className="mx-30 flex space-x-4 -mt-4"> {/* Adjusted margin to lift buttons */}
            <NavLink to="/admin/complaints">
              <button className="bg-blue-500 text-white py-3 px-6 rounded">VIEW COMPLAINT</button>
            </NavLink>
            <NavLink to="/admin/messages">
              <button className="bg-blue-500 text-white py-3 px-6 rounded">VIEW MESSAGES</button>
            </NavLink>
            <NavLink to="/review">
              <button className="bg-blue-500 text-white py-3 px-6 rounded">VOTE</button>
            </NavLink>
          </div>
        </header>
